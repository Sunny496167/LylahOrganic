...
import { Timer, Gift, Sparkles, ArrowRight, Tag, CalendarDays, Check } from 'lucide-react';
...
const PremiumOffers = () => {
  ...
  const offers = {
    'new-launch': {
      ...
      description: "Be among the first to experience our newest creation. A bold blend of rare ingredients that transcends conventional perfumery.",
      discount: "20% OFF",
      code: "NEWLAUNCH20",
    ...
    'special-discount': {
      ...
      description: "A special offering for our loyal customers. Receive complimentary gifts with purchase and priority access to our limited editions.",
      discount: "25% OFF",
      code: "VIPEXCLUSIVE",
      image: "/api/placeholder/500/600",
    ...
    'festival-offer': {
      ...
      description: "Curated gift sets perfect for the festive season. Exclusive packaging and complementary gift wrapping for a truly memorable present.",
      discount: "30% OFF",
      code: "HOLIDAY30",
      image: "/api/placeholder/500/600",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg mt-8 leading-relaxed">
            Indulge in our most prestigious limited-time offers, crafted for the discerning fragrance connoisseur
          </p>
        </motion.div>
        
        {/* Tab navigation */}
        <div className="flex flex-wrap justify-center gap-4 mb-12" role="tablist" aria-label="Premium offers categories">
          <TabButton 
            id="new-launch" 
            label="New Launch" 
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden group h-96 lg:h-full shadow-xl">
              <div className={`absolute inset-0 bg-gradient-to-t ${offers[activeTab].color} opacity-70 mix-blend-multiply`}></div>
              <img 
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xl font-mono tracking-wider">{offers[activeTab].code}</span>
                  <button 
        ...
        >
          {[
            ...
            >
              <div className={`p-3 rounded-full ${offers[activeTab].accent} bg-opacity-20`}>
                {benefit.icon}
              </div>
              <div>
